...
function Body() {
  return (
    <div className="w-full h-screen relative overflow-hidden">
      ...
      {/* Tarjetas */}
      <div className="absolute inset-0 flex flex-col md:flex-row justify-center items-center gap-6 p-6">
        {/* Tarjeta 1 */}
  ...
  <a
    ...
    className="bg-amber-950 rounded-md p-2 hover:bg-amber-800 inline-flex items-center gap-2"
  >
